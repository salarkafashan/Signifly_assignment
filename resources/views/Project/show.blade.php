    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="bg-gray-100 bg-opacity-25 grid md:grid-cols-2">
                    <div class="p-12">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-400"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">{{$project->name}} Details</div>
                        </div>
                    </div>
                    <div>
                ...
                <div class="bg-gray-200 bg-opacity-25 ">
                    ...
                    <div class="p-10">  
                        <div class="px-6 py-4"> 
                            ...
                            <p class="text-gray-600 text-sm mb-5">
                                Start Date: <span class="uppercase">{{substr($project->created_at, 0, 10)}}</span> 
                            </p>
                            <p class="text-gray-600 text-red-500 text-sm mb-5">
                                Dead Line: <span class="uppercase">{{$project->dead_line}}</span> 
                            </p>
                            <div class="mb-5">
                                ...
                                @forelse ($users as $user)
                                    <a href="{{ url('users', $user->id)}}">
                                        <div class="items-center mt-8">
                                            ...
                                            <p class="text-gray-600">{{$user->Role->name}}</p>
                                            </div>
                                        </div>
                                    </a>    
                                @empty
